            ...
            <div className="flex justify-between bg-white max-w-6xl mx-5 lg:mx-auto">
                ...
                <div className="max-w-xs">
                    <div className="relative mt-1 p-3 rounded-md">
                        ...
                        <input className="bg-gray-50 block w-full pl-10 sm:text-sm border-gray-300 focus:ring-black
                    ...
                    {session ? (
                        <>
                            <div className="relative navBtn">
                                ...
                                <div className="absolute -top-2 -right-2 text-xs w-5 h-5 bg-red-500 rounded-full items-center flex justify-center animate-pulse text-white">3</div>
                            </div>
