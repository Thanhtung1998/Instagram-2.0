...
function Modal() {
    ...
    const uploadPost = async () => {
        ...
        // 4) get a download URl from fb storage and update the original post image 
                    ...
                    <Transition.Child
                        ...
                        <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-lg transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
                            <div>
                                ...
                                {selectedFile ? (
                                    <img className="w-full object-contain cursor-pointer" src={selectedFile} onClick={() => setSelectedFile(null)} alt="File Upload" />
                                ) : (
                                    <div
                                ...
                                <div className="mt-5 sm:mt-6">
                                    <button
                                        ...
                                        onClick={uploadPost}
                                    >
                                        {loading ? "Upload Post... " : "Upload Post"}
                                    </button>
                                </div>
                            </div>
